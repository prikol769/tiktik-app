...
const Sidebar = () => {
    ...
    return (
        <div>
            <div
                className="block xl:hidden m-4 mt-3 text-xl items-center flex justify-center"
            ...
            {showSidebar && (
                <div
                    ...
                    {/*                        font-semibold px-6 py-3 rounded-md outline-none w-full mt-3 hover:text-white hover:bg-[#F51997] cursor-pointer"*/}
